...
def generate_single_output_file(module_name, binding, api_classes, env, output_file_name):
...
def default_generator(module_name, binding, api_classes, env, output_dir):
    ...
    output_file_name = os.path.join(output_dir,
            get_template_output(module_name, get_template_name(binding)))
    generate_single_output_file(module_name, binding, api_classes, env, output_file_name)
...
class GeneratorContext(object):
    ...
    def generate(self, module_name, binding, api_classes, env, output_dir):
        ...
        if binding in self._generator_map:
            ...
            return self._generator_map[binding](module_name, binding, api_classes, env, output_dir)
        else:
            log.info('  using default')
            return default_generator(module_name, binding, api_classes, env, output_dir)
...
def generate(module_name, binding, api_classes, env, output_dir):
    ...
    return generator_context.generate(module_name, binding, api_classes, env, output_dir)
